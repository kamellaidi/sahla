  ...
  return (
    <div className="max-container padding-container py-8">
      <div className="flex items-center gap-3 mb-2">
        <Hash className="text-[#E65100]" size={28} />
        <h1 className="text-3xl font-black text-[#1B4F72]">Guide Arabizi</h1>
      </div>
      ...
      <section className="mb-12">
        <h2 className="text-xl font-bold text-[#1B4F72] mb-4">Les chiffres — sons spéciaux</h2>
      ...
      <section className="mb-10">
        <h2 className="text-xl font-bold text-[#1B4F72] mb-4">Alphabet complet</h2>
        <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                <th className="text-left px-4 py-3 font-semibold text-gray-600">Arabizi</th>
                <th className="text-left px-4 py-3 font-semibold text-gray-600">Arabe</th>
                <th className="text-left px-4 py-3 font-semibold text-gray-600">Exemple</th>
              </tr>
            </thead>
            <tbody>
              {ALPHABET_TABLE.map((row, i) => (
                <tr key={row.latin} className={`border-b border-gray-50 ${i % 2 === 0 ? '' : 'bg-gray-50/50'}`}>
                  <td className="px-4 py-3 font-bold text-[#1B4F72] font-mono">{row.latin}</td>
                  <td className="px-4 py-3 text-lg">{row.arabe}</td>
                  <td className="px-4 py-3 text-gray-500 italic">{row.ex}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {/* Tips */}
      <section className="bg-[#1B4F72]/5 rounded-2xl p-6">
        <h2 className="text-lg font-bold text-[#1B4F72] mb-3">Conseils pour lire l&apos;arabizi</h2>
